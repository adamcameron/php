...
class MyServiceLoggedTest extends TestCase
{
    ...
    {
        error_log("IN CONSTRUCTOR  (" .spl_object_hash($this) . ")". PHP_EOL, 3, 'C:\temp\err6.log');
        parent::__construct($name, $data, $dataName);
    }

    public function setup()
    {
        error_log("IN TEST  (" .spl_object_hash($this) . ")". PHP_EOL, 3, 'C:\temp\err6.log');
    }
    ...
    {
        error_log("IN DP  (" .spl_object_hash($this) . ")". PHP_EOL, 3, 'C:\temp\err6.log');
        return [
            'tahi' =>['variant' => 1],
            'rua' =>['variant' => 2],
            'toru' =>['variant' => 3],
