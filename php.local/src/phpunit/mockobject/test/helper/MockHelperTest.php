...
class MockHelperTest extends \PHPUnit_Framework_TestCase {
    ...
    private function getMockHelper($mockBuilder) {
        $partiallyMockedMockHelper = $this->getMockBuilder('me\adamcameron\someapp\test\helper\MockHelper')
    ...
    private function getMockBuilderForNullConstructorArgsTest(){
        $mockedMockBuilder = $this->getMockBuilder('\PHPUnit_Framework_MockObject_MockBuilder')
